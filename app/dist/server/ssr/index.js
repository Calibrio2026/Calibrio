...
var client_references_default = {
	...
	"6efdf509a785": async () => {
		const m = await import("./assets/page-4WP8oNHU.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"a9bbde40cf2d": async () => {
		const m = await import("./assets/error-CeyPp86D.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"c7fa5cfea253": async () => {
		const m = await import("./assets/error-boundary-CHCA5W9s.js");
		return {
			get "ErrorBoundary"() {
	...
	"da06f1d026a2": async () => {
		const m = await import("./assets/layout-segment-context-CHXTwWLt.js");
